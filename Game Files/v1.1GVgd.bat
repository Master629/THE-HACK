...
echo 2) how to play
echo 3) Exit 
echo 4) music *NOT INCLUDED, DO NOT CLICK THE GAME WILL CRASH* *work in progress* *you will have to redownload the game when fixed, check if fixed on the website*
time /t
date /t
set /p number= >
